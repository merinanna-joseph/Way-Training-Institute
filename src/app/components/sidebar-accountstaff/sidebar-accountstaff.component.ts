...
@Component({
  selector: 'app-sidebar-accountstaff',
  templateUrl: './sidebar-accountstaff.component.html',
  styleUrls: ['./sidebar-accountstaff.component.css']
})
export class SidebarAccountstaffComponent implements OnInit {
  menuItems: any[];
