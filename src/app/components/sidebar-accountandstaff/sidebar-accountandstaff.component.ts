...
export const ROUTES: RouteInfo[] = [
  ...
  // { path: '/admissionform-display', title: 'Admission Form',  icon:'design_bullet-list-67', class: '' }  // { path: '/view_request', title: 'Events Management',  icon:'ui-1_calendar-60', class: '' },
  // { path: '/reports', title: 'Reports',  icon:'ui-1_calendar-60', class: '' },

];

@Component({
  selector: 'app-sidebar-accountandstaff',
  templateUrl: './sidebar-accountandstaff.component.html',
  styleUrls: ['./sidebar-accountandstaff.component.css']
})
export class SidebarAccountandstaffComponent implements OnInit {
  menuItems: any[];
